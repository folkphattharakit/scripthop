...
-- [ ❗ ย้าย FileName ลงไปข้างล่าง เพื่อไม่ให้สคริปต์ตายตอนเริ่ม ]
...
-- [ 1. 🎯 ระบบ Clicker - ใช้สูตรการกดของคุณเป๊ะๆ ]
task.spawn(function()
...
task.spawn(function()
    -- [[ 🛡️ ด่านตรวจ: รอจนกว่าชื่อจะโหลดเสร็จ สคริปต์จะได้ไม่ตาย ]]
